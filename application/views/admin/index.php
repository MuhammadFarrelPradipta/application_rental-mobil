            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge">
                            <?php echo $this->Mrental->get_data('mobil')->num_rows(); ?>
                        </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge">
                            <?php echo $this->Mrental->get_data('kustomer')->num_rows(); ?>
                        </div>
        ...
        <div class="panel panel-warning">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge">
                            <?php echo $this->Mrental->get_data('transaksi')->num_rows(); ?>
                        </div>
        ...
        <div class="panel panel-danger">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge">
                            <?php echo $this->Mrental->edit_data(array('transaksi_status' => 1), 'transaksi')->num_rows(); ?>
                        </div>
                ...
                <div class="list-group">
                    <?php foreach ($kustomer as $k) { ?>
                        <a href="#" class="list-group-item">
                            ...
                            <i class="glyphicon glyphiconuser"></i> <?php echo $k->kustomer_nama; ?>
                        </a>
                    <?php } ?>
                </div>
                <div class="text-right">
